            ...
            <div>
              ...
              <AnimatedSection delay={350}>
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-br from-rose-500/65 to-ciel-400/65 backdrop-blur-sm border border-white/20 text-sm font-medium text-white/80 hover:text-white transition-all duration-300 mb-8"
                >
              ...
              <AnimatedSection delay={400}>
                <div className="rounded-[1.5rem] overflow-hidden border border-blush/40 shadow-lg shadow-rose-100/10 aspect-[4/3]">
                  <iframe
