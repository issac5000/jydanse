export default function Marquee({ items }: { items: string[] }) {
  ...
  return (
    <div
      aria-hidden="true"
      className="group relative overflow-hidden py-8 bg-gradient-to-r from-ciel-500/65 via-ciel-400/65 to-rose-400/65"
    >
      {/* Fade edges */}
      ...
      <div className="animate-marquee group-hover:[animation-play-state:paused] inline-flex whitespace-nowrap">
        {doubled.map((item, i) => (
